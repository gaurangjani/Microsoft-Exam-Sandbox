...
function getExamConstraints(examCode) {
  const constraints = {
    'AB-100': 'CONSTRAINT: Agentic AI Business Solutions - focus ONLY on: Microsoft 365 Copilot, AI agents, generative AI fundamentals, responsible AI practices, business automation. DO NOT include Azure infrastructure, cloud administration, or technical developer content.',
    'AB-730': 'CONSTRAINT: AI Business Professional - focus ONLY on: Using Copilot in Microsoft 365 apps, prompt management, business content creation, meetings/collaboration. DO NOT include technical architecture or advanced AI engineering.',
    'AB-901': 'CONSTRAINT: Agentic AI Fundamentals - focus ONLY on: Basic AI concepts, using Copilot, Microsoft 365 integration, responsible AI practices. DO NOT include advanced features or Azure services.',
  };

  return constraints[examCode] || 'Focus strictly on the listed skills and topics only.';
}

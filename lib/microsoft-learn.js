...
function generateGenericOutline(examCode, exam) {
  // Generate outlines specific to exam code prefix, not just category
  const getExamTypeOutline = (code) => {
    const prefix = code.split('-')[0];

    const outlinesByPrefix = {
      'AZ': {
        name: 'Azure',
        skills: [
      ...
      'MB': {
        name: 'Dynamics 365',
        skills: [
          'Dynamics 365 core concepts',
          'Business process configuration',
          'Sales, service, and operations features',
      ...
      'MS': {
        name: 'Microsoft 365',
        skills: [
          'Microsoft 365 services and architecture',
      ...
      'PL': {
        ...
        skills: [
          ...
          'Power Apps creation and configuration',
      ...
      'DA': {
        ...
        skills: [
          'Power BI concepts and architecture',
      ...
      'AB': {
        ...
        skills: [
          'Generative AI and Copilot concepts',
          'Microsoft 365 Copilot capabilities',
          'AI-powered business productivity',
    ...
    return outlinesByPrefix[prefix] || {
      name: exam.category,
      skills: [
        `${exam.category} fundamentals and concepts`,
        `${exam.category} architecture and design`,
        `${exam.category} implementation and configuration`,
        `${exam.category} management and administration`,
        `${exam.category} security and compliance`,
      ],
    };
  };

  const examTypeOutline = getExamTypeOutline(examCode);
  const skillAreas = examTypeOutline.skills;

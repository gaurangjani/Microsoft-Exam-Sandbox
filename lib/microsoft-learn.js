...
export async function fetchExamOutline(examCode) {
  ...
  // For major exams: Use specific outlines
  // For other exams: Use auto-generated outlines
  ...
  // If specific outline exists, return it
  if (outlines[examCode]) {
    return outlines[examCode];
  }

  // Otherwise, auto-generate a realistic outline for any new exam
